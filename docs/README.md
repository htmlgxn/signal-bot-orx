...
BOT_SEARCH_MODE_LOLCOW_CYRAXX_ENABLED=true
BOT_SEARCH_MODE_LOLCOW_LARSON_ENABLED=true
...
BOT_SEARCH_BACKEND_JMAIL=jmail
BOT_SEARCH_BACKEND_LOLCOW_CYRAXX=lolcow_cyraxx
BOT_SEARCH_BACKEND_LOLCOW_LARSON=lolcow_larson
...
BOT_SEARCH_JMAIL_MAX_RESULTS=10
BOT_SEARCH_LOLCOW_CYRAXX_MAX_RESULTS=3
BOT_SEARCH_LOLCOW_LARSON_MAX_RESULTS=3
